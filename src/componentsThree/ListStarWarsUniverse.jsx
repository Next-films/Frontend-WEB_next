...
import { selectStarwars } from "../features/movie/movieSlice";

const ListStarWarsUniverse = () => {
  const movies = useSelector(selectStarwars);
...
export default ListStarWarsUniverse;
